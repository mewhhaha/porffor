...
impl ClassDeclaration {
    ...
    pub fn new(
        ...
        Self::new_with_decorators(name, super_ref, constructor, elements, Box::default())
    }

    /// Creates a new class declaration with decorators.
    #[inline]
    #[must_use]
    ...
    /// Gets the list of decorators attached to the class declaration.
    #[inline]
    #[must_use]
...
impl VisitWith for ClassDeclaration {
        ...
        V: VisitorMut<'a>,
    {
        ...
        for decorator in &mut *self.decorators {
            visitor.visit_expression_mut(decorator)?;
        }
...
impl ClassExpression {
    ...
    /// Creates a new class expression with decorators.
    #[inline]
    #[must_use]
    pub fn new_with_decorators(
        name: Option<Identifier>,
    ...
    /// Gets the list of decorators attached to the class expression.
    #[inline]
    #[must_use]
    pub const fn decorators(&self) -> &[Expression] {
        &self.decorators
...
pub enum ClassElement {
    ...
    /// An auto-accessor field definition.
    AccessorFieldDefinition(ClassFieldDefinition),

    /// A static field definition, accessible from the class constructor object
    StaticFieldDefinition(ClassFieldDefinition),

    /// A static auto-accessor field definition.
    StaticAccessorFieldDefinition(ClassFieldDefinition),
...
impl ClassFieldDefinition {
    ...
    /// Creates a new class field definition with decorators.
    #[inline]
    #[must_use]
    pub fn new_with_decorators(
        name: PropertyName,
    ...
    /// Returns the decorators attached to the class field definition.
    #[inline]
    #[must_use]
    pub const fn decorators(&self) -> &[Expression] {
        &self.decorators
    ...
    /// Sets the decorators attached to the class field definition.
    #[inline]
    pub fn set_decorators(&mut self, decorators: Box<[Expression]>) {
...
impl PrivateFieldDefinition {
    ...
    /// Returns the decorators attached to the private field definition.
    #[inline]
    #[must_use]
    pub const fn decorators(&self) -> &[Expression] {
        &self.decorators
...
impl ToIndentedString for ClassElement {
    fn to_indented_string(&self, interner: &Interner, indent_n: usize) -> String {
        ...
        match self {
            ...
            Self::AccessorFieldDefinition(field) => match &field.initializer {
                Some(expr) => {
                    format!(
                        "{indentation}accessor {} = {};\n",
                        field.name.to_interned_string(interner),
                        expr.to_no_indent_string(interner, indent_n + 1)
                    )
                }
            ...
            Self::StaticAccessorFieldDefinition(field) => match &field.initializer {
                Some(expr) => {
                    format!(
                        "{indentation}static accessor {} = {};\n",
                        field.name.to_interned_string(interner),
                        expr.to_no_indent_string(interner, indent_n + 1)
                    )
                }
...
impl VisitWith for ClassElement {
        ...
        V: Visitor<'a>,
    {
        match self {
            ...
            Self::FieldDefinition(field)
            | Self::AccessorFieldDefinition(field)
            | Self::StaticFieldDefinition(field)
            | Self::StaticAccessorFieldDefinition(field) => {
        ...
        V: VisitorMut<'a>,
    {
        match self {
            Self::MethodDefinition(m) => {
                for decorator in &mut *m.decorators {
                    visitor.visit_expression_mut(decorator)?;
                }
                match m.name {
...
impl ClassMethodDefinition {
    ...
    /// Creates a new class method definition with decorators.
    #[inline]
    #[must_use]
    pub fn new_with_decorators(
        name: ClassElementName,
    ...
    /// Returns the decorators attached to the class method definition.
    #[inline]
    #[must_use]
    pub const fn decorators(&self) -> &[Expression] {
        &self.decorators
    ...
    /// Sets the decorators attached to the class method definition.
    #[inline]
    pub fn set_decorators(&mut self, decorators: Box<[Expression]>) {
        self.decorators = decorators;
    }
