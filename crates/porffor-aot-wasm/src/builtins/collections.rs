...
const MAP_ITERATOR_KIND_KEYS: u64 = 0;
const MAP_ITERATOR_KIND_VALUES: u64 = 1;
const MAP_ITERATOR_KIND_ENTRIES: u64 = 2;
const SET_ITERATOR_KIND_VALUES: u64 = 0;
const SET_ITERATOR_KIND_ENTRIES: u64 = 1;
...
impl<'a> FunctionBuilder<'a> {
    ...
    pub(crate) fn emit_map_prototype_keys(
        ...
        self.emit_map_iterator_create(MAP_ITERATOR_KIND_KEYS, function)
    }
    ...
    pub(crate) fn emit_map_prototype_values(
        ...
        self.emit_map_iterator_create(MAP_ITERATOR_KIND_VALUES, function)
    }
    ...
    pub(crate) fn emit_map_prototype_entries(
        ...
        self.emit_map_iterator_create(MAP_ITERATOR_KIND_ENTRIES, function)
    }
    ...
    pub(crate) fn emit_map_iterator_next(
        ...
        function.instruction(&Instruction::I64Const(MAP_ITERATOR_KIND_VALUES as i64));
        function.instruction(&Instruction::I64Eq);
        function.instruction(&Instruction::If(BlockType::Empty));
        self.load_i64_to_local_from_offset(
            entry_local,
        ...
        function.instruction(&Instruction::LocalGet(kind_local));
        function.instruction(&Instruction::I64Const(MAP_ITERATOR_KIND_ENTRIES as i64));
        function.instruction(&Instruction::I64Eq);
        function.instruction(&Instruction::If(BlockType::Empty));
    ...
    pub(crate) fn emit_set_prototype_values(
        ...
        self.emit_set_iterator_create(SET_ITERATOR_KIND_VALUES, function)
    }
    ...
    pub(crate) fn emit_set_prototype_entries(
        ...
        self.emit_set_iterator_create(SET_ITERATOR_KIND_ENTRIES, function)
    }
    ...
    pub(crate) fn emit_set_iterator_next(
        ...
        function.instruction(&Instruction::LocalGet(kind_local));
        function.instruction(&Instruction::I64Const(SET_ITERATOR_KIND_ENTRIES as i64));
        function.instruction(&Instruction::I64Eq);
        function.instruction(&Instruction::If(BlockType::Empty));
        let pair_local = self.reserve_temp_local();
        let pair_index_local = self.reserve_temp_local();
