...
let boxedString = valueOf.call("porffor");
let symbol = Symbol("porffor");
...
let otherBoxedString = otherValueOf.call("porffor");
...
valueOf.call(object) === object
  ...
  && otherBoxedString.valueOf() === "porffor"
