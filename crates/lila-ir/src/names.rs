...
pub const ASSERT_THROWS_NAME: &str = "__lilaAssertThrows";
pub const IS_CONSTRUCTOR_NAME: &str = "__lilaIsConstructor";
pub const CREATE_REALM_NAME: &str = "__lilaCreateRealm";
pub const CREATE_HTMLDDA_NAME: &str = "__lilaCreateHTMLDDA";
...
pub const DETACH_ARRAY_BUFFER_NAME: &str = "__lilaDetachArrayBuffer";
pub const HOST_DETACH_ARRAY_BUFFER_FUNCTION_ID: &str = "$host.detachArrayBuffer";
pub const AGENT_START_NAME: &str = "__lilaAgentStart";
pub const AGENT_BROADCAST_NAME: &str = "__lilaAgentBroadcast";
pub const AGENT_RECEIVE_BROADCAST_NAME: &str = "__lilaAgentReceiveBroadcast";
pub const AGENT_REPORT_NAME: &str = "__lilaAgentReport";
pub const AGENT_GET_REPORT_NAME: &str = "__lilaAgentGetReport";
pub const AGENT_SLEEP_NAME: &str = "__lilaAgentSleep";
pub const AGENT_MONOTONIC_NOW_NAME: &str = "__lilaAgentMonotonicNow";
pub const AGENT_LEAVING_NAME: &str = "__lilaAgentLeaving";
...
pub const DYNAMIC_GENERATOR_FUNCTION_CONSTRUCTOR_FUNCTION_ID: &str = "$dynamic.GeneratorFunction";
pub const DYNAMIC_ASYNC_FUNCTION_CONSTRUCTOR_FUNCTION_ID: &str = "$dynamic.AsyncFunction";
pub const DYNAMIC_ASYNC_GENERATOR_FUNCTION_CONSTRUCTOR_FUNCTION_ID: &str =
...
//
// They survive as `&'static str` because `crates/lila-aot-wasm` still keys
