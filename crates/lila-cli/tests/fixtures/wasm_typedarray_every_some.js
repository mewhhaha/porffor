...
for (let invalidReceiver of [{}, [], Object.create(sample)]) {
  __lilaAssertThrows(TypeError, function () { every.call(invalidReceiver, function () {}); });
  __lilaAssertThrows(TypeError, function () { some.call(invalidReceiver, function () {}); });
}
__lilaAssertThrows(TypeError, function () { every.call(sample, 1); });
__lilaAssertThrows(TypeError, function () { some.call(sample, {}); });
...
__lilaAssertThrows(TypeError, function () { every.call(detached, function () {}); });
...
__lilaAssertThrows(TypeError, function () { some.call(shrinkView, function () {}); });
