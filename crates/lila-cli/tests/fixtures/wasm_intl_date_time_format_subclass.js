...
// `standard_builtin_signature` (`lila-ir/src/lowering.rs`).
//
...
//
// `./target/debug/lila inspect`, script result kind:
//
...
// `lila run --execution-backend wasm` on the three-class probe below answered:
//
...
// `receiver_needs_dynamic_helper_dispatch` (`lila-aot-wasm/src/functions.rs`),
