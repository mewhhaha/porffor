...
__lilaAssertThrows(TypeError, function () { new Iterator.concat(); });
...
__lilaAssertThrows(TypeError, function () { reentrant.next(); });

__lilaAssertThrows(TypeError, function () { Iterator.concat("primitive"); });
__lilaAssertThrows(TypeError, function () { Iterator.concat({ [Symbol.iterator]: null }); });
