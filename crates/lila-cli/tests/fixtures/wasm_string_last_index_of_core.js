...
check("abc".lastIndexOf("", undefined), 3, "empty search explicit undefined");
check("abc".lastIndexOf("a", undefined), 0, "explicit undefined searches from end");
check("abc".lastIndexOf("b", undefined), 1, "explicit undefined finds later match");
check("ababa".lastIndexOf("ba", NaN), 3, "direct NaN position searches from end");
var nanPosition = {
  valueOf: function() {
    return NaN;
  }
};
check("ababa".lastIndexOf("ba", nanPosition), 3, "direct object NaN position");
check(
  String.prototype.lastIndexOf.call("ababa", "ba", NaN),
  3,
  "borrowed NaN position"
);
check(
  String.prototype.lastIndexOf.call("ababa", "ba", nanPosition),
  3,
  "borrowed object NaN position"
);
