...
for (let invalidReceiver of [{}, [], Object.create(sample)]) {
  __lilaAssertThrows(TypeError, function () { find.call(invalidReceiver, function () {}); });
  __lilaAssertThrows(TypeError, function () { findIndex.call(invalidReceiver, function () {}); });
  __lilaAssertThrows(TypeError, function () { findLast.call(invalidReceiver, function () {}); });
  __lilaAssertThrows(TypeError, function () { findLastIndex.call(invalidReceiver, function () {}); });
}
__lilaAssertThrows(TypeError, function () { find.call(sample, 1); });
__lilaAssertThrows(TypeError, function () { findIndex.call(sample, {}); });
__lilaAssertThrows(TypeError, function () { findLast.call(sample, 1); });
__lilaAssertThrows(TypeError, function () { findLastIndex.call(sample, {}); });
...
__lilaAssertThrows(TypeError, function () { find.call(detached, function () {}); });
...
__lilaAssertThrows(TypeError, function () { find.call(shrinkView, function () {}); });
...
let reverseDetachedIndex = reverseDetach.findLastIndex(function (value, index) {
  if (index === 2) {
    __lilaDetachArrayBuffer(reverseDetach.buffer);
    return false;
  }
