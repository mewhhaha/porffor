...
impl<'a> FunctionBuilder<'a> {
    pub(super) fn emit_boolean_builtin(
        &mut self,
        ...
        match builtin {
            ...
            BooleanBuiltin::PrototypeToString | BooleanBuiltin::PrototypeValueOf => {
                ...
                if builtin == BooleanBuiltin::PrototypeValueOf {
