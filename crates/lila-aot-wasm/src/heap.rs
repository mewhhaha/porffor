...
pub(crate) const OBJECT_KIND_MODULE_NAMESPACE: u64 = BOXED_PRIMITIVE_KIND_SYMBOL + 1;
pub(crate) const PROXY_HANDLER_PAYLOAD_MIN: u64 = OBJECT_KIND_MODULE_NAMESPACE + 1;
...
pub(crate) const HEAP_REALM_INTRINSICS_LAYOUT: &[HeapLayoutSlot] = &[
    ...
    HeapLayoutSlot {
        ...
        offset: HEAP_REALM_INTRINSICS_SUPPRESSED_ERROR_PROTOTYPE_OFFSET,
        width: 8,
        pointer: true,
    },
    HeapLayoutSlot {
