...
fn object_read_realm_source_exhaustively_projects_every_helper_body() {
    ...
    assert_eq!(
        helper_projection
            ...
            .collect::<String>()
            .matches("RuntimeHelperId::ObjectRead|RuntimeHelperId::ObjectReadProxy|RuntimeHelperId::IndexedElementRead|RuntimeHelperId::ObjectHasProperty|RuntimeHelperId::WithEnvironmentHasBinding|RuntimeHelperId::ValueToString|RuntimeHelperId::ValueToNumber|RuntimeHelperId::ValueToNumeric|RuntimeHelperId::ValueToPrimitiveDefault|RuntimeHelperId::ValueToPrimitiveNumber|RuntimeHelperId::ValueToPrimitiveString=>Self::ObjectReadHelperArgument,")
            .count(),
        1
    );
    assert_eq!(
