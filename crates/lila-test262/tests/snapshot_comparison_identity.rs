...
fn compare_requires_existing_candidate_name() {
    ...
    fixture.assert_missing_name("baseline", "missing-candidate", "missing-candidate", "baseline");
}
...
fn compare_rejects_two_missing_names() {
    ...
    fixture.assert_missing_name("missing-base", "missing-candidate", "missing-base", "unrelated");
}
...
fn compare_rejects_incomplete_exact_candidate() {
    ...
    fs::write(&path, serde_json::to_vec(&value).expect("snapshot should encode"))
