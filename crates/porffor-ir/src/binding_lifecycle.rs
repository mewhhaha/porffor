...
impl TdzViolation {
    /// The ReferenceError of 9.1.1.1.6 step 2 and 9.1.1.1.5 step 3. One message,
    /// one `NativeErrorKind`, one `ValueInfo`, produced here rather than
    /// re-spelled at each of the seven sites.
    ///
