...
- Grug continuously update `README.md` with user-visible progress after work changes capabilities, conformance, CLI behavior, architecture, or development workflow; do this before calling the task done.
