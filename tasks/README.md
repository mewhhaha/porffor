...
an exact 449-entry generated inventory. Every entry has a closed classification,
reason and concrete owner/removal task; none uses the old aggregate
`T26-unclassified` owner. The inventory still contains 368 semantic shortcuts,
