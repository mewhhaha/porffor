...
| Removal task | Semantic shortcuts |
| --- | ---: |
| `T03` | 1 |
| `T09` | 1 |
| `T13` | 3 |
...
Every inventory entry has a closed classification, reason and concrete owner/removal task. Do not close a semantic task from focused green leaves while that task's full-tree and materialization-removal criteria remain unmet.
